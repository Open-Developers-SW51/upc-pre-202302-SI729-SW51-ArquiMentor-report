...
| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería. | López Huarcaya, Leonardo Paul </br>*TB1* </br> Elaboración del Web Aplications UX/UI Design.<br>Elaboración del Sprint 1.<br>Elaboración del Software Configuration Management.<br>*TP*<br> Corrección de mis partes elaboradas de la primera entrega.<br>Elaboración del sprint 2.<br/>*TB2*<br/>Corrección del sprint Backlog 2 y la documentacion del sprint 3.<br/>Elaboración del Validation Interviews.<br/>*TF1*<br/>Implementacion del sprint 4 de forma grupal<br><br>Kurt Puican </br>*TB1*</br>Creacion del studen outcome,la solution profile,user persona,journey,empathy,canvas y LeanUx, asi mismo como todo el cap 2</br>*TP*</br>Correccion de mis partes de la tb1 que estaban de forma incorrecta, asi mismo como la elaboracion de mis componentes y la correccion de la entrevista.<br/>*TF1*<br/>Implementacion del sprint 4 de forma grupal</br> Rafael Luyo</br>*TB1*</br>Creación de Landing Page Ui Design, Database.</br>*TP*</br>Corrección de Database y Landing Page.<br>Mejora de redaccion de entrevista<br/>*TF1*<br/>Implementacion del sprint 4 de forma grupal</br><br>Diego Ramirez<br>*TB1*<br> Elaboración de los diagramas C4 de nuestra arquitectura de software<br>*TP*<br>Correcciones en el diagrama de contenedores y de componentes. Elaboración del sprint 2</br></br>*TB2*</br>Agregar y editar los diagramas C4 y la evaluación de heurística<br>*TF*<br>Correciones de los diagrama c4 y añadido nuevos elementos para la app</br>Juliana Yauricasa</br>*TB1*</br>Creación de las user stories y la especificación de requisitos.</br>*TP*</br>Corrección de la especificación de requisitos, priorización del Product Backlog y los criterios de aceptación.<br>Elaboración del Sprint 2. </br>*TB2*</br>Documentación de los tests. </br>Corrección del product backlog.   </br>*TF*</br>Corrección del product backlog y avance del sprint 4. Comunicación con el equipo por medios como Whatsapp.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | La elaboración del informe nos ayudo a idcar y organizar nuestro proyecto, tanto como las funcionalidades, los requisitos, las problematicas y diseños. Todo esto necesario para poner en marcha la elaboración del Web Aplications.<br><br>Las correcciones que se realizaron en el proyecto ayudaron a crear nuevas funcionalidades para el Web Applications. <br><br> El desarrollo del sprint facilita la organización para la creación del Sitio Web.</br><br>Expresar nuestras ideas y resultados por escrito de manera clara y objetiva fue esencial en nuestro proyecto de ingeniería. Cuando escribimos informes y documentos, nos ayudó a organizar la información de manera ordenada, lo que permitió que personas con diferentes antecedentes y roles la entendieran fácilmente. Esta comunicación por escrito precisa y objetiva fue fundamental para guiar nuestro trabajo y garantizar que todos estuvieran en la misma sintonía en nuestro equipo</br> |
...
| 2       	  | US020    | Reconocer las ventajas de Arquimentor a través del landing page      | Como visitante del landing page quiero conocer las ventajas de la plataforma para saber si se ajusta a lo que necesito.	                              			| 2                       	  	  |
| 3       	  | US006    | Búsqueda de asesor                                            	      | Como usuario estudiante quiero buscar a un asesor para que me oriente en mi proyecto.	                                                                		| 3                       		  |
...
| 5      	   | US009    | Enviar una solicitud a un asesor                              	      | Como usuario estudiante quiero enviar una solicitud a un asesor para que me oriente con mi proyecto.	                                                 		| 2                       		  |
| 6       	  | US011    | Programar reuniones	                                                 | Como usuario estudiante quiero programar las reuniones con el asesor para que me oriente y me de feedback. 	                                           			| 3                       		  |
| 7      	   | US013    | Registrar el avance del proyecto	                             				   | Como usuario asesor quiero medir el avance del proyecto para tener un control de cada estudiante.	                                               | 3                       		  |
| 8      	   | US012    | Visualizar las reuniones programadas	                         			    | Como usuario asesor quiero tener mis reuniones programadas en una agenda para ser más eficiente.	                                                  | 2                       		  |
| 9      	   | US014    | Visualizar los avances del proyecto	                          			    | Como usuario estudiante quiero visualizar los avances y el feedback recibido para conocer el estado de mi proyecto.	                                  	 | 2                       		  |
| 10       	 | US004    | Subir proyectos	                                               					 | Como usuario estudiante quiero subir mis proyectos actuales y pasados para encontrar al asesor que más se adapte a mi perfil.                  | 3                      		  |
| 11      	  | US008    | Visualizar perfiles de asesores                               				   | Como usuario estudiante quiero ingresar al perfil de los asesores para conocer su trayectoria.                                                        	| 2                       		  |
| 12      	  | US015    | Calificar a un asesor	                                        				   | Como usuario estudiante quiero calificar al asesor que me orientó para compartir mi experiencia con otros usuarios.	                          | 2                       		  |
| 13      	  | US016    | Visualizar las reseñas a los asesores.                        				   | Como usuario estudiante quiero leer las opiniones de otros estudiantes para encontrar un asesor confiable.	                                           	| 1                       		  |
| 14      	  | US017    | Seleccionar un plan de suscripción	                           			    | Como usuario estudiante quiero seleccionar un plan de suscripción que se adecue a mis necesidades para acceder a otras funcionalidades de la plataforma. | 2                       		  |
| 15      	  | US018    | Cambiar plan de suscripción	                                  				   | Como usuario estudiante quiero modificar mi plan de suscripción de acuerdo con mis necesidades para acceder a los beneficios de la aplicación. 	 | 1                       		  |
| 16      	  | US001    | Registrar cuenta                                               					 | Como usuario quiero crear una cuenta para poder acceder a la plataforma.                                                                          | 1                      		  |
| 17      	  | US002    | Iniciar sesión 	                                              						 | Como usuario quiero ingresar a mi cuenta para utilizar la plataforma.                                                                          | 1                      		  |
| 18      	  | US003    | Cerrar sesión	                                                					  | Como usuario quiero cerrar mi sesión para mantener mis datos seguros.	                                                                        | 1                       		  |
| 19      	  | US005    | Subir Curriculum Vitae	                                       					  | Como usuario asesor quiero subir mi CV para que los estudiantes me conozcan mejor y confíen en mi experiencia.	                                   | 2                       		  |
| 20      	  | US007    | Filtrar la búsqueda de asesor                                 				   | Como usuario estudiante quiero filtrar la búsqueda de asesor para encontrar al asesor que más se ajuste a mis horarios y necesidades                  	| 2                      		  |
| 22       	 | US024    | Configurar el Backend		                                   				       | Como desarrollador, quiero configurar el backend de la plataforma para garantizar el funcionamiento eficiente.          							| 8                       		  |
| 21      	  | US023    | Sistema de Autenticación y Registro                           				   | Como desarrollador, quiero implementar un sistema de autenticación y registro.                                                                         	| 3                       		  |
| 23       	 | US021    | Diseñar la Interfaz de Usuario                                				   | Como desarrollador, quiero diseñar una interfaz de usuario atractiva y fácil de usar para una experiencia agradable.                                  | 5                       		  |
| 24       	 | US025        	 | Optimizar el Rendimiento de la Aplicación                   		 	     | Como desarrollador, quiero optimizar el rendimiento de la aplicación para una experiencia rápida y fluida.                                           | 5                       		  |
| 25      	  | US022    | Funcionalidad de Búsqueda Avanzada                            			    | Como desarrollador, quiero desarrollar la funcionalidad de búsqueda avanzada con filtros.                                                              		| 3                       		  |
...
<img src="https://cdn.discordapp.com/attachments/1149190528756363340/1176975165884727316/image.png?ex=6570d28a&is=655e5d8a&hm=c25937433d94157acdc82fccb08e112303608f3d8d4e93496a52dcbff6132eaf&" alt="database-diagram">
...
<img src="https://cdn.discordapp.com/attachments/1149190528756363340/1176975551945248819/image.png?ex=6570d2e6&is=655e5de6&hm=f85e8b3424c9ded0be0fc0d9c5f5d3e10a1539fb0421380143a0f5f3be7afb7f&">
...
| Repository                           | Branch            | Commit id                         | Commit Message                                             | Commit message body                          | Committed on |
|--------------------------------------|-------------------|-----------------------------------|------------------------------------------------------------|---------------------------------------------|--------------|
| Leonardo/Arquimentor-platform        | Feature/database  | 3c6245fed25e4c7bf90454233587169cc385ab36 | feat(dataBase): Added data base in port deployment.   | Se agrego el puerto de la base de datos para deployar | 7/11/23      |
| Leonardo/Arquimentor-platform        | Feature/database  | bd3a0c30bb7f98feeaf5cb9bad76d06dc2869964 | feat(dataBase): Added data base in port deployment.   | Se agrego el puerto para deployar              | 7/11/23      |
| Leonardo/Arquimentor-platform        | Feature/database  | 077c34db334a8e2b7082865d8ec1a81cf6510788 | feat(dataBase): Modifique data base to localhost.     | Modificacion de la base de datos a localhost | 14/11/23     |
| Leonardo/Arquimentor-platform        | Feature/resources | 37e49e48525f89565640fde6ec06b4bb6a56c11b | feat(resources): Update resources of mentor profile and student profile. | Actualizacion de los resources de mentor y estudiante | 16/11/23 |
| Leonardo/Arquimentor-platform        | Feature/mentor-profile | 1dd2d95b5c931c1c4465576ffe79029c4a9142d9 | feat(Mentor-Profile): Added attribute slogan and nick for Mentor profile. | Se agrego un atributo eslogan e Nick para el mentor profile | 16/11/23 |
| Leonardo/Arquimentor-platform        | Feature/publication | e9e53c17cf47b5c8754dbf4e1dc9245ce5e0c682 | feat(Publication): Modify the id of publication from a mentor to a mentor id. | Se modifico el id de publicacion de mentor a mentor id | 17/11/23 |
| JulianaYS/Arquimentor-platform       | Chore/security    | adcfa57f1c117b70a2bde23bf3dd720580c41d94 | chore: added security and jwt dependencies.             | Se agrego seguridad y dependencias jwt         | 17/11/23     |
| JulianaYS/Arquimentor-platform       | Chore/security    | 6080c1a4307e810f7e992339cfb99182b35100f0 | chore: added and implemented hashing service.          | Se agrego e implemento el servicio hashing    | 17/11/23     |
| JulianaYS/Arquimentor-platform       | Chore/security    | 4900b32b2d1c15818e9a92cdd82568b6a3ad8179 | chore: added and implemented token service.           | Se agrego el servicio ed tokem               | 17/11/23     |
| JulianaYS/Arquimentor-platform       | Chore/security    | f00a3a8fa16efb8e4628e2a54d617c4b5219232d | chore: added apache commons dependency.               | Se agrego las dependencias commons apache     | 17/11/23     |
| JulianaYS/Arquimentor-platform       | Feature/security  | 871852f9c64daae6488a1bdd49be8cff0257df8b | feat(security): implemented user command service.    | Se implemento el servicio ed user command    | 17/11/23     |
| JulianaYS/Arquimentor-platform       | Feature/security  | ae678ad20e26fa25f0a4137cb0a57f42203b5cb8 | feat(security): added bcrypt service and update hashing service. | Se agrego bcrypt service y update hashing service | 17/11/23 |
| JulianaYS/Arquimentor-platform       | Feature/security  | 366706116f509e5679a94db8bb86576eded21494 | feat(security): added bearer token service.           | Se agrego el bearer token service            | 17/11/23     |
| JulianaYS/Arquimentor-platform       | Chore/security    | 1c970cb7d1becb0494d04ffc45df3dd82ea535e5 | chore: added jsonwebtoken dependencies.               | Se agrego las dependencias de jsonwbtoken    | 17/11/23     |
| JulianaYS/Arquimentor-platform       | Feature/security  | b560244b9b3d10eb9cb00a5c5854011d22af10c1 | feat(security): added user model and jwt configuration. | Se agrego el modelo de jwt de usuario configuration | 17/11/23 |
| JulianaYS/Arquimentor-platform       | Feature/security  | af5607b70faa6bff50d7ffb057e0598aca33b7b2 | feat(security): added implementation for user details service. | Se agrego e implemento el servicio de los detalles del usuario | 17/11/23 |
| JulianaYS/Arquimentor-platform       | Feature/security  | 585f25204895b7b18c3f7d059f86eb9b0532526e | feat(security): added authorization filter and unauthorized request handler. | Se agrego la autorizacion y la unauthorized request handler | 17/11/23 |
| JulianaYS/Arquimentor-platform       | Feature/security  | dccb80321f63dda0b55e9f7ba7b9d82dcec61370 | feat(security): added web security configuration.     | Se agrego la configuracion de web            | 17/11/23     |
| JulianaYS/Arquimentor-platform       | Feature/security  | df18d7dfb41bc35f3a1ea27412ff79e38c96fa09 | feat(security): added resources to interfaces.       | Se agrego los recursos a las interfaces      | 17/11/23     |
| JulianaYS/Arquimentor-platform       | Feature/security  | b9f90ccdce40c0336ca937908d75c394b9728cba | feat(security): added transform to interfaces.       | Se agrego la transformacion                   | 17/11/23     |
| JulianaYS/Arquimentor-platform       | Feature/security  | 890d6eb9ef7e4767fdc63bb2676244776259fba0 | feat(security): added authentication controller.     | Se agrego la autenticacion del controlador   | 17/11/23     |
| JulianaYS/Arquimentor-platform       | Feature/security  | 3a66b473896af17da7f9fc9b4a3126b14bdf1fa9 | feat(security): added roles controller.              | Se agrego los roles de controlador            | 17/11/23     |
| JulianaYS/Arquimentor-platform       | Feature/security  | 2c11f850e60fcf6940be3e23ae4f02b03a17a0aa | feat(security): added user controller.               | Se agrego controler del usuario               | 17/11/23     |
| JulianaYS/Arquimentor-platform       | Docs/security     | f6bee6a01814cf1ed6d1df0f2aaa4d187458c927 | docs: added security documentation.                   | Se agrego la documentacion de seguridad       | 17/11/23     |
| Leonardo/Arquimentor-platform        | Feature/token     | 2b848e895498f14b0b40250209cb136873c32487 | feat(token): Update configuration for tha localhost. | Se actualizo la configuracion para el localhost | 18/11/23     |
| Leonardo/Arquimentor-platform        | Feature/student   | d97d62611bd2b19d3039b3489f8e33355f36d3ef | feat(student): Email correction.                      | Correccion de email                          | 18/11/23     |
| Leonardo/Arquimentor-platform        | Feature/configuration | d32ea3fb2a9015bdb0fcf5f906b1d8343f87749d | feat(configuration): Update configuration endpoint student profile. | Se actualizo el endpoint de la configuracion del perfil de estudiante | 19/11/23 |
| RafaelLuyo/Arquimentor-platform      | Feature/stripe    | 9b12bac106f7e8facaf41ec19dfdc2fb88c0bc77 | feat(stripe): add stripe controller, http, model, repository and service | Se agrego el stripe controller, http, model, repository and service | 19/11/23 |
| Leonardo/Arquimentor-platform        | Feature/update-file | 91bb4c5af954c45e66c6c7db80e495fb958755d2 | feat(update-file): update file naming based on DDD.  | Se actualizo el archive llamandolo base don DDD | 21/11/23 |
